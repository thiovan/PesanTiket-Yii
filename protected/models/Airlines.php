...
class Airlines extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_airline, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'costs' => array(self::HAS_MANY, 'Costs', 'id_airline'),
			'transactions' => array(self::HAS_MANY, 'Transactions', 'id_airline'),
		);
	}
